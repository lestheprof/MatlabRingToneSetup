setup ; % set a and harms_single: edit to alter
...
nl = {{'A4', 1, ap, notetype1, harms_single, levelminus6db}, ...
    {'D5', 1, ap, notetype1, harms_single, level1}, ...
    {'F#5', 1, ap, notetype1, harms_single, levelminus6db},...
    {'A4', 1, ap,notetype1, harms_single, levelminus6db}, ...
    {'D5', 1, ap, notetype1, harms_single, level1}, ...
    {'F#5', 1, ap, notetype1, harms_single, levelminus6db}, ...
    {'A4', 1, ap, notetype1, harms_single, levelminus6db}, ...
  {'D5', 6, ap,notetype1, harms_single, level1}} ; % put into a note list: edit to alter
